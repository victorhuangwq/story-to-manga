...
export const comicPageLogger = createModuleLogger('comic-page-generation');
...
export const logError = (
  ...
  logger.error(errorData, `Error in ${context}: ${error instanceof Error ? error.message : 'Unknown error'}`);
};