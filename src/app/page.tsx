	...
	const generateComic = async () => {
		...
		try {
			...
			for (let i = 0; i < breakdown.pages.length; i++) {
				...
				setCurrentStepText(
					`Generating comic page ${i + 1}/${breakdown.pages.length}...`,
				);
				...
				<div className="col-md-8">
					<div className="comic-panel h-100 p-4">
						...
						<div className="accordion accordion-manga">
							...
							<div className="accordion-item">
								...
								>
									<div className="accordion-body">
										{storyBreakdown ? (
											<div>
												{storyBreakdown.pages.map((page) => (
													<div key={`page-${page.pageNumber}`} className="mb-4">
														<h5>Page {page.pageNumber}</h5>
														<p>
															<strong>Layout:</strong> {page.panelLayout}
														</p>
														<div className="row">
							...
							<div className="accordion-item">
								<h2 className="accordion-header" id={pagesHeadingId}>
									<button
										className="accordion-button collapsed"
										type="button"
										data-bs-toggle="collapse"
										data-bs-target={`#${pagesCollapseId}`}
									>
										<span className="me-2">
											{generatedPages.length > 0 ? "✅" : "⏳"}
										</span>
										Step 4: Generated Pages
										<span
											className={`badge ${generatedPages.length > 0 ? "badge-manga-success" : "badge-manga-warning"} ms-auto me-3`}
										>
											...
											<div>
												...
												<div className="row">
													{generatedPages.map((page) => (
														<div
															key={`generated-page-${page.pageNumber}`}
															...
															<div className="text-center">
																...
																<button
																	...
																	onClick={() =>
																		downloadImage(
																			page.image,
																			`comic-page-${page.pageNumber}.jpg`,
																		)
																	}
																>
																	Download Page
