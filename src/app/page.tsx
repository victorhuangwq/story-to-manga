...
const GENERATION_PAUSE_MESSAGE =
	"We're out of NanoBanana credits and are refactoring the app to use the new NanoBanana Pro. Generation is temporarily paused; please star the GitHub repo to get notified when we're back!";
const GITHUB_REPO_URL = "https://github.com/victorhuangwq/story-to-manga";
...
export default function Home() {
	...
	return (
		<div className={`min-h-screen py-4 px-4 style-${style}`}>
			...
			<div className="comic-panel mb-4 border-2 border-manga-warning bg-manga-warning/10">
				<div className="flex items-start gap-3">
					<div className="text-2xl" aria-hidden="true">
						⚠️
					</div>
					<div>
						<p className="font-semibold">Generation temporarily paused</p>
						<p className="text-sm mt-1 text-manga-dark-gray">
							{GENERATION_PAUSE_MESSAGE}
						</p>
				...
				<div className="w-full lg:w-1/3 mb-4 lg:mb-0">
					<div className="comic-panel h-full">
						...
						<button
							...
							title={GENERATION_PAUSE_MESSAGE}
						>
							{isGenerationPaused ? (
